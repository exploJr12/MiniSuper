...
namespace SysMiniSuperWebAPI.Controllers
{
    public class ProveedorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdProveedor,Nombre,Direccion,Telefono,correo")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProveedor,Nombre,Direccion,Telefono,correo")] Proveedor proveedor)
        {
